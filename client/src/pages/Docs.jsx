          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="flex">
                ...
                <span className="text-gray-600">Team Invincible</span>
              </li>
              <li className="flex">
                <span className="font-medium text-teal-700 w-32">Hackathon:</span>
                <span className="text-gray-600">Smart India Hackathon</span>
              </li>
            </ul>
          </div>
